...
json = json.load(open('./results_traditional_KS.json','r'))
fname = 'density_trad'
# json = json.load(open('./results_extend_KS.json','r'))
# fname = 'density_extend'
ne = np.array(json["input"]["Ge"]).shape[0]
nb = np.array(json["input"]["knotsb"]).shape[0]
